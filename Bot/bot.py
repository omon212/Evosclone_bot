...
#
#
# @dp.message_handler(text='Ketchup',state=Evos_state.menu_garnirlar)
# async def garnirlar1(message:types.Message,state:FSMContext):
#     photo = open("Images/ketchup.jpg", "rb")
#     await message.answer_photo(photo=photo,reply_markup=ketchup,caption="Narx: 2 000 so'm")
#
#
#
# @dp.message_handler(text='Guruch',state=Evos_state.menu_garnirlar)
# async def ketsh(message:types.Message):
#     photo = open("Images/guruch.jpg", "rb")
#     await message.answer_photo(photo=photo, reply_markup=guruch, caption="Narx: 7  000 so'm")
#
#
#
# @dp.message_handler(text='Tovuq Strips',state=Evos_state.menu_garnirlar)
# async def ketsh(message:types.Message):
#     photo = open("Images/tovuqstrips.jpg", "rb")
#     await message.answer_photo(photo=photo, reply_markup=garnir_inline_button, caption="Narx: 19 000 so'm")
#
#
# @dp.message_handler(text='Pishloqli sous',state=Evos_state.menu_garnirlar)
# async def pishloqsous(message:types.Message):
#     photo = open("Images/pishloqsous.jpg", "rb")
#     await message.answer_photo(photo=photo, reply_markup=garnir_inline_button, caption="Narx: 2 000 so'm")
#
# @dp.message_handler(text='Chisnokli sous',state=Evos_state.menu_garnirlar)
# async def pishloqsous(message:types.Message):
#     photo = open("Images/chisnoksous.jpg", "rb")
#     await message.answer_photo(photo=photo, reply_markup=garnir_inline_button, caption="Narx: 2 000 so'm")
#
...
#
#
# @dp.message_handler(text='Barbekyu sousi',state=Evos_state.menu_garnirlar)
# async def pishloqsous(message:types.Message):
#     photo = open("Images/barbekusous.jpg", "rb")
#     await message.answer_photo(photo=photo, reply_markup=garnir_inline_button, caption="Narx: 2 000 so'm")
#
#
# @dp.message_handler(text='Salat',state=Evos_state.menu_garnirlar)
# async def pishloqsous(message:types.Message):
#     photo = open("Images/salat.jpg", "rb")
#     await message.answer_photo(photo=photo, reply_markup=garnir_inline_button, caption="Narx: 7 000 so'm")
#
#
#
...
# async def pishloqsous(message:types.Message):
#     photo = open("Images/non.jpg", "rb")
#     await message.answer_photo(photo=photo, reply_markup=garnir_inline_button, caption="Narx: 3 000 so'm")
#
#
# @dp.message_handler(text='Fri',state=Evos_state.menu_garnirlar)
# async def pishloqsous(message:types.Message):
#     photo = open("Images/fri.jpg", "rb")
#     await message.answer_photo(photo=photo, reply_markup=garnir_inline_button, caption="Narx: 14 000 so'm")
#
# @dp.message_handler(text='Ortga qaytish 🔙', state=Evos_state.menu_garnirlar)
# async def menyu(message: types.Message, state: FSMContext):
#     await message.answer('Tanlang:', reply_markup=menu)
#     await state.finish()
#
